...
- `warmup.md` — how inbox warmup works, schedule, ramp, what it fixes
- `campaigns.md` — sequences, steps, sending, delays, tags, spam safety
- `leads.md` — import, verification, dedupe, suppressions
- `signup-verification.md` — account creation, email verification, login, resend
